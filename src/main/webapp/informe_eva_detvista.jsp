...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="container-fluid mt-5">
            ...
            <div class="card shadow-sm">
                <div class="card-header text-white text-center" style="background: linear-gradient(135deg, #10243c 5%, #17a2b8 90%);">
                    <h4>Informe de Evaluaciones</h4>
                </div>
                <div class="card-body">
                    <div class="text-center mb-4">
                        <p>Seleccione un rango de fechas para generar el informe de evaluaciones generales.</p>
                    </div>

                    <form action="informe_eva_detallado.jsp" target="_blank" method="get" class="user">
                        <div class="row">
                            <!-- Campo Fecha Inicio -->
        ...
        <button type="button" class="btn btn-primary" onclick="location.href = 'evaluaciones.jsp'">Nueva evaluación</button>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">Ref.</th>
